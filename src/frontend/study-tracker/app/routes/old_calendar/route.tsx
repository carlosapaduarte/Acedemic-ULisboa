...
function TimeGranularityChangeButtons({ onCalendarViewChangeClick }: {
    onCalendarViewChangeClick: (type: TimeGranularity) => void
}) {
    return (
        <div>
        ...
        if (action != Navigate.TODAY) {
            ...
            switch (selectedTimeGranularity) {
                case TimeGranularity.MONTH :
                    newDate.setMonth(navigateOnMonth(baseDate, action));
                    break;
                case TimeGranularity.WEEK :
                    newDate.setDate(navigateOnWeek(baseDate, action));
                    break;
                case TimeGranularity.DAY :
                    newDate.setDate(navigateOnDay(baseDate, action));
            }
        } else {
            newDate = new Date();
        }
